            ...
            fields: {
                sWord: {
                    validators: {
                        ...
                        regexp: {
                            regexp: "",
                            message: 'Il campo pu&ograve; contenere solamente caratteri alfanumerici'
                        },
                        callback:{
                            message: 'La parola non &egrave; palindroma'
                        }
                    }
                }
            }
                ...
                if(result.valid){
                    ...
                    switch(result.type)
                    {
                        case "lenght":
                            ...
                            break;
                        case "regx":
                            $form.data('bootstrapValidator').updateStatus('sWord', 'INVALID', "regexp")
                            break;
                        case "check":
